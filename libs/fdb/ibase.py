...
isc_info_read_idx_count = (
    24  # number of reads done via an index since the database was last attached
)
isc_info_insert_count = (
    25  # number of inserts into the database since the database was last attached
)
isc_info_update_count = (
    26  # number of database updates since the database was last attached
)
isc_info_delete_count = (
    27  # number of database deletes since the database was last attached
)
...
isc_info_forced_writes = (
    52  # mode in which database writes are performed: 0=sync, 1=async
)
isc_info_user_names = (
    53  # array of names of all the users currently attached to the database
)
...
isc_info_db_file_size = (
    112  # added in FB 2.1, nbackup-related - size (in pages) of locked db
)
fb_info_page_contents = (
    113  # added in FB 2.5, get raw page contents; takes page_number as parameter;
)
# Added in Firebird 3.0
fb_info_implementation = (
    114  # (cpu code, OS code, compiler code, flags, implementation class)
)
...
isc_info_tra_oldest_interesting = (
    5  # oldest interesting tran ID when current tran started
)
...
isc_info_svc_implementation = (
    56  # Retrieves the implementation of the Firebird server */
)
isc_info_svc_capabilities = (
    57  # Retrieves a bitmask representing the server's capabilities */
)
isc_info_svc_user_dbpath = (
    58  # Retrieves the path to the security database in use by the server */
)
...
isc_info_svc_to_eof = (
    63  # Retrieves as much of the server output as will fit in the supplied buffer */
)
isc_info_svc_timeout = (
    64  # Sets / signifies a timeout value for reading service information */
)
...
isc_info_svc_auth_block = (
    69  # FB 3.0: Sets authentication block for service query() call */
)
...
isc_info_db_impl_linux_mipsel = (
    71  # changed in 2.1, it was isc_info_db_impl_sun_amd64 in 2.0
)
# Added in FB 2.1
...
blobcallback._fields_ = [
    (
        "blob_get_segment",
        CFUNCTYPE(c_short, c_void_p, POINTER(ISC_UCHAR), c_ushort, POINTER(ISC_USHORT)),
    ),
...
class fbclient_API(object):
    ...
    def __init__(self, fb_library_name=None):
        ...
        if fb_library_name is None:
            ...
            # http://bugs.python.org/issue16283
                ...
                if not fb_library_name:
                    ...
                    if key:
                        ...
                        fb_library_name = os.path.join(
                            os.path.join(instFold[0], "bin"), "fbclient.dll"
                        )
            else:
            ...
            if not file_name:
                raise Exception(
                    "Firebird Client Library '%s' not found" % fb_library_name
                )
            else:
        ...
        self.isc_attach_database.argtypes = [
            POINTER(ISC_STATUS),
            c_short,
            STRING,
        ...
        self.isc_array_gen_sdl.argtypes = [
            POINTER(ISC_STATUS),
        ...
        self.isc_array_get_slice.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_db_handle),
        ...
        self.isc_array_lookup_bounds.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_db_handle),
            POINTER(isc_tr_handle),
            STRING,
        ...
        self.isc_array_lookup_desc.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_db_handle),
            POINTER(isc_tr_handle),
            STRING,
        ...
        self.isc_array_set_desc.argtypes = [
            POINTER(ISC_STATUS),
            STRING,
            STRING,
            POINTER(c_short),
        ...
        self.isc_array_put_slice.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_db_handle),
            POINTER(isc_tr_handle),
            POINTER(ISC_QUAD),
        ...
        self.isc_blob_default_desc.argtypes = [
        ...
        self.isc_blob_gen_bpb.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(ISC_BLOB_DESC),
            POINTER(ISC_BLOB_DESC),
            c_ushort,
        ...
        self.isc_blob_info.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_blob_handle),
            c_short,
            STRING,
            c_short,
            POINTER(c_char),
        ...
        self.isc_blob_lookup_desc.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_db_handle),
            POINTER(isc_tr_handle),
            POINTER(ISC_UCHAR),
        ...
        self.isc_blob_set_desc.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(ISC_UCHAR),
            POINTER(ISC_UCHAR),
            c_short,
        ...
        self.isc_cancel_events.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_db_handle),
            POINTER(ISC_LONG),
        ]
        ...
        self.isc_commit_retaining.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_tr_handle),
        ]
        ...
        self.isc_commit_transaction.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_tr_handle),
        ]
        ...
        self.isc_create_blob2.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_db_handle),
            POINTER(isc_tr_handle),
            POINTER(isc_blob_handle),
        ...
        self.isc_create_database.argtypes = [
            POINTER(ISC_STATUS),
            c_short,
            STRING,
            POINTER(isc_db_handle),
        ...
        self.isc_database_info.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_db_handle),
            c_short,
            STRING,
        ...
        self.isc_detach_database.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_db_handle),
        ]
        ...
        self.isc_dsql_allocate_statement.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_db_handle),
        ...
        self.isc_dsql_alloc_statement2.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_db_handle),
            POINTER(isc_stmt_handle),
        ]
        ...
        self.isc_dsql_describe.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_stmt_handle),
            c_ushort,
            POINTER(XSQLDA),
        ...
        self.isc_dsql_describe_bind.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_stmt_handle),
            c_ushort,
            POINTER(XSQLDA),
        ...
        self.isc_dsql_exec_immed2.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_db_handle),
            POINTER(isc_tr_handle),
            c_ushort,
        ...
        self.isc_dsql_execute.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_tr_handle),
            POINTER(isc_stmt_handle),
            c_ushort,
        ...
        self.isc_dsql_execute2.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_tr_handle),
            POINTER(isc_stmt_handle),
            c_ushort,
        ...
        self.isc_dsql_execute_immediate.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_db_handle),
            POINTER(isc_tr_handle),
            c_ushort,
        ...
        self.isc_dsql_free_statement.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_stmt_handle),
            c_ushort,
        ]
        ...
        self.isc_dsql_prepare.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_tr_handle),
            POINTER(isc_stmt_handle),
            c_ushort,
        ...
        self.isc_dsql_set_cursor_name.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_stmt_handle),
            STRING,
            c_ushort,
        ...
        self.isc_dsql_sql_info.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_stmt_handle),
            c_short,
            STRING,
        ...
        self.isc_event_counts.argtypes = [
        ...
        self.isc_prepare_transaction2.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_tr_handle),
            ISC_USHORT,
            POINTER(ISC_UCHAR),
        ...
        self.isc_rollback_retaining.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_tr_handle),
        ]
        ...
        self.isc_rollback_transaction.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_tr_handle),
        ]
        ...
        self.isc_start_multiple.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_tr_handle),
            c_short,
            c_void_p,
        ...
        if sys.platform in ["win32", "cygwin", "os2", "os2emx"]:
            P_isc_start_transaction = CFUNCTYPE(
                ISC_STATUS,
                POINTER(ISC_STATUS),
                POINTER(isc_tr_handle),
                c_short,
            ...
            self.isc_start_transaction = P_isc_start_transaction(
                ("isc_start_transaction", fb_library)
            )
        else:
            ...
            self.isc_start_transaction.argtypes = [
                POINTER(ISC_STATUS),
                POINTER(isc_tr_handle),
                c_short,
                POINTER(isc_db_handle),
        ...
        self.isc_transaction_info.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_tr_handle),
            c_short,
            STRING,
        ...
        self.isc_transact_request.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_db_handle),
            POINTER(isc_tr_handle),
            c_ushort,
        ...
        self.isc_compile_request.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_db_handle),
            POINTER(isc_req_handle),
            c_short,
            STRING,
        ]
        ...
        self.isc_compile_request2.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_db_handle),
            POINTER(isc_req_handle),
            c_short,
        ...
        self.isc_prepare_transaction.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_tr_handle),
        ]
        ...
        self.isc_reconnect_transaction.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_db_handle),
            POINTER(isc_tr_handle),
            c_short,
        ...
        self.isc_release_request.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_req_handle),
        ]
        ...
        self.isc_request_info.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_req_handle),
            c_short,
            c_short,
        ...
        self.isc_start_and_send.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_req_handle),
            POINTER(isc_tr_handle),
            c_short,
        ...
        self.isc_start_request.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_req_handle),
            POINTER(isc_tr_handle),
            c_short,
        ...
        self.isc_unwind_request.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_tr_handle),
            c_short,
        ]
        ...
        self.isc_wait_for_event.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_db_handle),
            c_short,
            POINTER(ISC_UCHAR),
        ...
        self.isc_execute_immediate.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_db_handle),
            POINTER(isc_tr_handle),
            POINTER(c_short),
        ...
        self.isc_dsql_execute_m.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_tr_handle),
            POINTER(isc_stmt_handle),
            c_ushort,
        ...
        self.isc_dsql_execute2_m.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_tr_handle),
            POINTER(isc_stmt_handle),
            c_ushort,
        ...
        self.isc_dsql_execute_immediate_m.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_db_handle),
            POINTER(isc_tr_handle),
            c_ushort,
        ...
        self.isc_dsql_exec_immed3_m.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_db_handle),
            POINTER(isc_tr_handle),
            c_ushort,
        ...
        self.isc_dsql_fetch_m.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_stmt_handle),
            c_ushort,
            STRING,
        ...
        self.isc_dsql_insert_m.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_stmt_handle),
            c_ushort,
            STRING,
        ...
        self.isc_dsql_prepare_m.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_tr_handle),
            POINTER(isc_stmt_handle),
            c_ushort,
        ...
        self.isc_embed_dsql_describe.argtypes = [
            POINTER(ISC_STATUS),
            STRING,
            c_ushort,
            POINTER(XSQLDA),
        ...
        self.isc_embed_dsql_describe_bind.argtypes = [
            POINTER(ISC_STATUS),
            STRING,
            c_ushort,
            POINTER(XSQLDA),
        ...
        self.isc_embed_dsql_execute.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_tr_handle),
            STRING,
            c_ushort,
        ...
        self.isc_embed_dsql_execute2.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_tr_handle),
            STRING,
            c_ushort,
        ...
        self.isc_embed_dsql_execute_immed.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_db_handle),
            POINTER(isc_tr_handle),
            c_ushort,
        ...
        self.isc_embed_dsql_fetch.argtypes = [
            POINTER(ISC_STATUS),
            STRING,
            c_ushort,
            POINTER(XSQLDA),
        ...
        self.isc_embed_dsql_fetch_a.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(c_int),
            STRING,
            ISC_USHORT,
        ...
        self.isc_embed_dsql_open.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_tr_handle),
            STRING,
            c_ushort,
        ...
        self.isc_embed_dsql_open2.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_tr_handle),
            STRING,
            c_ushort,
        ...
        self.isc_embed_dsql_insert.argtypes = [
            POINTER(ISC_STATUS),
            STRING,
            c_ushort,
            POINTER(XSQLDA),
        ...
        self.isc_embed_dsql_prepare.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_db_handle),
            POINTER(isc_tr_handle),
            STRING,
        ...
        self.isc_service_attach.argtypes = [
            POINTER(ISC_STATUS),
            c_ushort,
            STRING,
        ...
        self.isc_service_detach.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_svc_handle),
        ]
        ...
        self.isc_service_query.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_svc_handle),
        ...
        self.isc_service_start.argtypes = [
            POINTER(ISC_STATUS),
            POINTER(isc_svc_handle),
            POINTER(isc_resv_handle),
            c_ushort,
        ...
        self.P_isc_event_block = CFUNCTYPE(
            ISC_LONG,
            POINTER(POINTER(ISC_UCHAR)),
            POINTER(POINTER(ISC_UCHAR)),
            ISC_USHORT,
        )
